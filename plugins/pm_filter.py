    ...
    if settings['button']:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"1 | {get_size(file.file_size)} | {file.file_name}", callback_data=f'files#{file.file_id}'
                ),
            ]
            for file in files
        ]
        ...
        btn = [
            [
                ...
                InlineKeyboardButton(
                    text=f"2 | {get_size(file.file_size)} |",
...
async def auto_filter(client, msg, spoll=False):
    ...
    if settings["button"]:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"3 | {get_size(file.file_size)} | {file.file_name}", callback_data=f'{pre}#{file.file_id}'
                ),
            ]
            for file in files
        ]
        ...
        btn = [
            [
                ...
                InlineKeyboardButton(
                    text=f"4 | {get_size(file.file_size)} |",
